...
Options:
 -i, --newinit  the file to execute as the new init;     dafault: current init
 -r, --newroot  the mountpoint to use as new root;       default: /
 -o, --putold   the path to mount the old root if --newroot is set;  dafault: /._tmp_reinit/putold
